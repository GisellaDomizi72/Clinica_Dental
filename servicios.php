...
<body style="padding-top: 100px;">
    ...
    <div class="container text-center my-4">
        <h1 class="display-4"> Servicios DentalCare</h1>
        &nbsp;
        <div class="container my-4">
            ...
            $query = "SELECT servicios.nombre_s, servicios.descripcion_s , servicios.precio_s, dentistas.nombre_d,dentistas.apellido_d from servicios inner join dentistas where servicios.id_dentista = dentistas.id_dentista;";
            $resultado = mysqli_query($conexion, $query);
            if (mysqli_num_rows($resultado) > 0) {
                while ($row = mysqli_fetch_assoc($resultado)) {
                    echo "<hr>";
                    echo "<h3>" . $row['nombre_s'] . "</h3>";
                    echo "<p>" . $row['descripcion_s'] . "</p>";
                    echo "<p> El valor de este servicio es de " . $row['precio_s'] . " ARS</p>";
                    echo "<p> Dr: " . $row['nombre_d'] . " " . $row['apellido_d'] . "</p>";
                    echo "<hr>";
                }
            } 
